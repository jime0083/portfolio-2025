...
const appItems = [
  {
    ...
    fullDesc: '無料で使えるエンジニア向けスキルシート作成ツール。作ったスキルシートはPDFだけでなくWordファイルやExcelファイルでもダウンロード可能',
    url: '#',
  ...
  },
  {
    ...
    fullDesc: 'メトロノーム,タイマー,音源再生といった楽器練習に必要な機能を1つのアプリにまとめたアプリ',
    url: '#',
  ...
  },
  {
    ...
    fullDesc: 'iPhoneの背面を3回タップし録画開始!痴漢冤罪・パワハラ・セクハラの証拠を残せるアプリ',
  ...
  },
  {
    ...
    fullDesc: 'iPhoneの背面を2回タップし録音開始!痴漢冤罪・パワハラ・セクハラの証拠を残せるアプリ',
  ...
  },
  {
    ...
    fullDesc: 'サボり・3日坊主を卒業！絶対にサボれないエンジニア向け学習習慣化アプリ',
  ...
  },
  {
    ...
    fullDesc: '10分で名刺作成、QRコードで共有できるエンジニア向け名刺作成アプリ',
  ...
  },
  {
    ...
    fullDesc: 'ポモドーロテクニックに頼らずあなたを集中状態に導くアプリ',
    url: '',
    skills: 'Javascript(ReactNative),HTML,CSS,Git,Firebase',

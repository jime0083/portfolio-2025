<template>
  <div id="page-work" class="page-section is-active" data-page="work" ref="containerRef">
    <main id="primary-work" class="site-main">
      <section class="top">
      ...
      <section class="work-field">
        <div class="work-container">
          <h2 class="field-section-title js-split-text" ref="fieldTitle">対応可能領域</h2>

          <div class="field-list">
            <div class="field-item">
              <div class="field-image fade-in-left">
                <img :src="baseUrl + 'assets/images/work2.png'" alt="フロントエンド開発">
              </div>
            ...
            <div class="field-item reverse">
              <div class="field-image fade-in-right">
                <img :src="baseUrl + 'assets/images/work1.png'" alt="Webサイト制作">
              </div>
            ...
            <div class="field-item">
              <div class="field-image fade-in-left">
                <img :src="baseUrl + 'assets/images/work3.png'" alt="Webデザイン">
              </div>
              <div class="field-main fade-in-right">
                <div class="field-header">
      ...
      <section class="work-ex">
        <div class="work-container">
          <h2 class="ex-section-title js-split-text" ref="exTitle">過去の事例紹介(一部)</h2>
          ...
          <div class="case-study-list">
            <div class="case-study fade-in-up">
              ...
              <div class="case-content">
                <div class="case-image">
                  <img :src="baseUrl + 'assets/images/spana1.png'" alt="事例画像">
            ...
            <div class="case-study fade-in-up">
              ...
              <div class="case-content">
                <div class="case-image">
                  <img :src="baseUrl + 'assets/images/helth.png'" alt="事例画像">
            ...
            <div class="case-study fade-in-up">
              ...
              <div class="case-content">
                <div class="case-image">
                  <img :src="baseUrl + 'assets/images/shop.png'" alt="事例画像">
...
const exTitle = ref(null)

let observer = null

const initSplitText = () => {
  const targets = [fieldTitle.value, exTitle.value]
